...
The second paper addresses the specific problem of estimating the direction to the source of gravitational-waves from a compact object collision, by approximating the log likelihood posterior PDF on the sky in terms of the integral for which the first paper provided a fast numerical scheme.
